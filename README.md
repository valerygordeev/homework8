...
### Переименование VG
   Проверяем наименование группы:
     vgs
   Переименовываем группу:
     vgrename centos_centos7 OtusRoot
   Переименовываем группу в конфигурационных файлах:
   ...
   Пересобираем initrd image с новым наименованием VG
     mkinitrd -f -v /boot/initramfs-$(uname -r).img $(uname -r)
   Перезагружаем VM
   Проверяем наименование VG
     vgs

### Добавление скриптов в initrd
   Создаем директорию 01test
   ...
   или
     dracut -f -v
   Можно проверить загружен ли модуль test в образ:
